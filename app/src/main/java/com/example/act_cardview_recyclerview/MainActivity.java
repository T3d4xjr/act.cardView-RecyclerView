...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.reciclador), (v, insets) -> {
        ...
        reciclador.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(@NonNull RecyclerView rv, @NonNull MotionEvent e) {
                ...
                if(hijo!=null && gestureDetector.onTouchEvent(e)) {
                    int posicion = reciclador.getChildAdapterPosition(hijo);

                    Toast.makeText(getApplicationContext(),datos.get(posicion).getTextoTitulo(),Toast.LENGTH_SHORT).show();
                }
                return false;
